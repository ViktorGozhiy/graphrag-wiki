...
PROMPT_TEMPLATE = (
    ...
    "list), and a one-sentence description grounded in the passage. For each "
    "relation give: source (an entity name), relation (from the list), target "
    "(an entity name), and a one-sentence description. Both endpoints of a "
    "relation must be entities you listed.\n\n"
    "Passage:\n{text}\n"
)
